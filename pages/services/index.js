...
const features = [
  {
    ...
    cover: <img className="rounded-t-lg h-62" src="https://images.unsplash.com/photo-1522204523234-8729aa6e3d5f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80" />,
  },
  {
    name: 'Corporate Websites',
    description: 'Build a modern & blazing fast website deployed on global content delivery cloud',
    cover: <img className="rounded-t-lg h-62" src="https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1650&q=80" />,
  },
];
  ...
  return (
    <>
      ...
      <div className="relative">
        <div className="z-0 absolute top-3/4 left-1/3 w-96 h-96 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-50 animate-blob animation-delay-4000" />
        <div className="z-0 absolute top-2/3 left-1/3 w-96 h-96 bg-purple-300 rounded-full mix-blend-overlay filter blur-xl opacity-50 animate-blob" />
        <div className="z-0 absolute top-3/4 left-1/2 w-96 h-96 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-50 animate-blob animation-delay-2000" />
            ...
            >
              <motion.dl variants={variants} className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                {features.map((feature) => (
                  <motion.div key={feature.name} className="relative bg-white z-10 rounded-b-lg" variants={itemVariants}>
                    <dt>
                      {feature.cover}
                      <p className="ml-4 mt-4 text-lg leading-6 font-medium text-gray-900 dark:text-gray-200">{feature.name}</p>
                    </dt>
                    <dd className="mt-2 ml-4 mb-4 text-base text-gray-500">{feature.description}</dd>
                  </motion.div>
                ))}
              </motion.dl>
            </motion.div>

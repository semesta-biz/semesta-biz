...
const CorporateHome = () => {
  ...
  const height = elementDimensions.height > 200 ? (elementDimensions.height + 200) : elementDimensions.height;
  const width = elementDimensions.width > 400 ? (elementDimensions.width + 200) : elementDimensions.width;
  return (
    <motion.div
      variants={{
        initial: {
    ...
    >
      <header className={`px-5 md:px-0 ${BLOG.font === 'serif' ? 'font-serif' : 'font-sans'}`}>
        <div className="container md:flex mx-auto">
          <div>
            <h1 className="text-2xl lg:text-5xl leading-none font-extrabold tracking-tight mt-10 sm:mt-14 mb-3 text-gray-900 dark:text-white">
            ...
            <p className="text-xl text-gray-800 dark:text-white">Work with us to get your business an outstanding digital profile with a tailored-made website.</p>
            <ul className="list-inside my-3 space-y-2 text-gray-800 dark:text-white">

    ...
    <header className={`relative max-w-screen-lg xl:max-w-screen-xl mx-auto ${
      ...
      <div className="px-4 md:px-0 my-10 xl:my-8 lg:flex z-10 relative">
        <div className="lg:w-1/2">
          <h1 className="text-4xl mt-8 sm:text-6xl lg:text-5xl leading-none font-extrabold tracking-tight text-gray-900 mb-8 sm:mb-10">
            WE CONNECT PEOPLE TO DATA AND TECHNOLOGY
          </h1>
          <div className="max-w-screen-lg text-lg sm:text-2xl sm:leading-10 font-medium text-gray-500 mb-10 sm:mb-11">
        ...
        <div ref={elementRef} className="lg:w-1/2 transform translate-y-10 md:-translate-y-8 scale-110 overflow-hidden md:overflow-auto">
          <lottie-player
            ref={lottieRef}
            id="firstLottie"
